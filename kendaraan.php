...
<body>
    <div class=container>
        <h1 class="text-center" style="margin: 20px 0 20px 0;">DATA INVENTARIS KATEGORI KENDARAAN</h1>
        ...
        <div class="tb-isi text-center col align-self-end">
            ...
            <tbody >
                <?php
                    ...
                    $query = mysqli_query ($connection, "SELECT * FROM inventaris WHERE kategori LIKE '%Kendaraan%'");
                        $s=1;
