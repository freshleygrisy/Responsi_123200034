...
<body>
    <div class=container>
        <h1 class="text-center" style="margin: 20px 0 20px 0;">DATA INVENTARIS KATEGORI ALAT TULIS KANTOR</h1>
        <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd;">
        <div class="container-fluid">
            <a class="navbar-brand" href="tampilan1.php">Beranda</a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="data.php">Daftar Inventaris</a>
                </li>
        ...
        <div class="tb-isi text-center col align-self-end">
            ...
            <tbody >
                <?php
                    ...
                    $query = mysqli_query ($connection, "SELECT * FROM inventaris WHERE kategori LIKE '%Alat Tulis Kantor%'");
                        $s=1;
